...
var endpoint = 'https://southeastasia.api.cognitive.microsoft.com/vision/v2.1';
...
app.listen(portNum, function() {
    console.log("Aplikasi web terakses dari port " + portNum);
});
...
function configurationMiddleware(req, res, next) {
    ...
    var verifyConfigValue = function(keyName) {
        ...
        if(!configValue) {
            throw new Error(keyName + " tidak terdefinisi.");
        }
        return configValue;
    };
